...
def separateTasks(order_df, numOfVehicles):
    ...
    data1 = pd.DataFrame([[0, 0, 'Port MSP', 0, timeWindow[0], timeWindow[1],'MSP']],columns=df_MSP.columns) # Departure Point
    data2 = pd.DataFrame([[0, 0, 'Port West', 0, timeWindow[0], timeWindow[1], 'West']],columns=df_West.columns) # Departure Point
